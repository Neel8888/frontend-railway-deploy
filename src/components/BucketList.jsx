...
function BucketList({setUrl}) {
    ...
    const fetchBucketList = async () => {
        try {
            const response = await axios.get('https://mybackend-deploy-production.up.railway.app/get_bucket_list');
    ...
    //     if (urlToAdd.trim() !== '' && shortNameToAdd.trim() !== '') {
    //         try {
    //             await axios.post('https://mybackend-deploy-production.up.railway.apploy.onrender.comloy.onrender.comloy.onrender.comloy.onrender.comloy.onrender.com/add_to_bucket_list', {
    //                 url: urlToAdd,
        ...
        if (urlToAdd.trim() !== '' && shortNameToAdd.trim() !== '') {
            try {
                if (editIndex !== null) {
                    ...
                    await axios.put(`https://mybackend-deploy-production.up.railway.app/update_bucket_list/${urlId}`, {
                        url: urlToAdd,
                        shortName: shortNameToAdd,
                        id: urlId
                    });
                    ...
                    // Add new item
                    await axios.post('https://mybackend-deploy-production.up.railway.app/add_to_bucket_list', {
                        url: urlToAdd,
                        shortName: shortNameToAdd
                    });
                }
    ...
    const deleteFromBucketList = async (shortName) => {
        try {
            await axios.delete(`https://mybackend-deploy-production.up.railway.app/delete_from_bucket_list/${shortName}`);
